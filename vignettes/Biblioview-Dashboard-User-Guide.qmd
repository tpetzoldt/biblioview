---
title: "User Guide: Exploring Literature with the biblioview Dashboard"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{User Guide: Exploring Literature with the biblioview Dashboard}
...
> 🔒 **Security Note on API Keys:** Your API key is passed directly in the URL query string. Do not share or publish pre-configured links publicly to keep your library access secure.
