...
#'
#' Handles paginated API requests (100 items per page) to retrieve all top-level
#' items from a specific Zotero collection key.
#'
#' @param group_id Character or numeric. The target Zotero Group ID.
#' @param api_key Character. Your secret Zotero Web API v3 key.
#' @param collection_key Character. The unique alphanumeric key for the sub-collection.
#'
#' @return A data frame of processed items belonging to the collection.
#' @export
